//
//  HYShimmerLoader.swift
//
//  Created by Hadi on 08/06/2022.
//
...
@objc public protocol ListLoadable{
    func getVisibleContentViews()->[UIView]
}

@objc extension UITableView : ListLoadable{
    public func getVisibleContentViews()->[UIView]{
...
@objc open class ListLoader: NSObject{
    ...
    public static func addLoaderTo(_ list : ListLoadable, coverColor: UIColor ){
        self.addLoaderToViews(list.getVisibleContentViews(), coverColor: coverColor)
    }
    
    public static func removeLoaderFrom(_ list : ListLoadable ){
        self.removeLoaderFromViews(list.getVisibleContentViews())
    }
}
